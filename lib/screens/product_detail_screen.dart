...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void _loadProductData() {
    ...
    _skuController.text = 'HFC-001';
    _barcodeController.text = '123456789012';
    _expiryDateController.text = '12/31/2025';
  }
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          onTap: onTap,
          style: TextStyle(
            color: readOnly ? Colors.grey[700] : const Color(0xFF1A1A1A),
          ),
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          if (_isEditing) _buildAddMoreButton(),
        ],
      ),
    );
  }
...
// Barcode Scanner Screen (reused from add product)
